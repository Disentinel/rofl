...
test('the split: mechanism is 723 of 995 code lines, policy 173 — by query', () => {
  ...
  assert.equal(rows(W, 'code_line(engine_ts, L, K)'), 995);
...
test('the report renders and carries its own headline', () => {
  ...
  assert.match(text, /TOTAL\s+995 code/);
