...
export * from './sim.ts';
import { BUDGET, FRAME, type Ent, START, PROPS, WIDTH, HEIGHT, clone, must, head as simHead, publish, rows, col, type Key, parseKey, intentWeight, type Fold, arbitrate, scoreFacts, settle, type Act, chosen, STRIKE_DAMAGE, TEND_HEAL, type Outcome, physics, proposeRule, ruleIds, type RuleDiff, ruleSetDiff } from './sim.ts';

export const head = (extra: string = ''): Rofl => simHead(BOOT, NPC, extra);
