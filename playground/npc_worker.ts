...
import { init, reset, step, why, whynot, propose, learn, past, unloop } from './npc_host.ts';

const ops: Record<string, (...a: never[]) => unknown> = { init, reset, step, why, whynot, propose, learn, past, unloop };
